...
android {
  ...
  defaultConfig {
    applicationId = "com.aistudio.aerovpn.tuygq"
    minSdk = 24
    targetSdk = 36
    versionCode = 1
    versionName = "1.0"
...
tasks.register("downloadHomaFont") {
    notCompatibleWithConfigurationCache("Downloads binary asset at configuration time")
    doLast {
